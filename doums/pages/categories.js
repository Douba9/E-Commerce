  ...
  return (
    <>
      <div className="w-full">
        ...
        <Search />
        <Head>
          <title>Trevor Familly - All Categories</title>
          <meta name="description" content={`Trevor Familly - All categories`} />
          <meta property="og:title" content="Trevor Familly - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
