  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Trevor Familly</title>
          <meta name="description" content="Trevor Familly Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js." />
          <meta property="og:title" content="Trevor Familly" key="title" />
        </Head>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm">Find the product for your satisfaction.</p>
      </div>
