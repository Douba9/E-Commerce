...
let inventory = [
  {
    categories: ['pc portable'], name: 'ASUS republic of gamer G17', price: '1 789,99', image: '/products/G17.jpeg', description: 'Play where you go.', brand: 'DoubaCorp', currentInventory: 15
  },  
  {
    categories: ['new arrivals','pc portable'], name: 'ASUS republic of gamer G531', price: '1 489,99', image: '/products/G531.jpeg', description: 'Play where you go.', brand: 'DoubaCorp', currentInventory: 15
  },
  {
  ...
  {
    categories: ['ecran'], name: 'LG 42" CURVE', price: '1 500', image: '/products/LG.jpeg', description: 'Large screen CURVE, recommanded for gaming and devellopement.', brand: 'DoubaCorp', currentInventory: 10
  },
  {
  ...
  {
    categories: ['processeur'], name: 'Nvidia GPU', price: '1 200', image: '/products/nvidia-cpu.jpeg', description: 'Latest version of th ebest processor in the public sells.', brand: 'DoubaCorp', currentInventory: 7
  },
  {
  ...
  {
    categories: ['new arrivals','ecran'], name: 'Samsung ARK 55"', price: '3 249,49', image: '/products/ark.jpeg', description: 'Best quality best song live your awsome dream.', brand: 'DoubaCorp', currentInventory: 4
  },
  {
