        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Image:</strong>
		            <textarea class="form-control" style="height:150px" name="image" placeholder="image_path">{{ $product->image }}</textarea>
		        </div>
		    </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
		        <div class="form-group">
		            <strong>Categorie:</strong>
		            <textarea class="form-control" style="height:150px" name="categorie" placeholder="categorie">{{ $product->categorie }}</textarea>
		        </div>
		    </div>
